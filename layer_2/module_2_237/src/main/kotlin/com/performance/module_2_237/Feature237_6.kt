...
class Feature237Provider : ContentProvider() {
    private val database = Feature237Database()
    private val coroutineScope = CoroutineScope(SupervisorJob() + Dispatchers.IO)
        ...
        private val repository4 = Feature193Repository()
        private val repository5 = Feature180Repository()
        private val repository6 = Feature162Repository()
