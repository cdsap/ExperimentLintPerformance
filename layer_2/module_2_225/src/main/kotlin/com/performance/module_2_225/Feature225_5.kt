...
class Feature225Service : Service(), LifecycleOwner {
    private val lifecycleRegistry = LifecycleRegistry(this)
        ...
        private val worker3 = Feature174Worker()
        private val worker4 = Feature182Worker()
        private val worker5 = Feature168Worker()
...
class Feature225Worker {
    fun doWork(): String {
        return "Work from Feature 225 Worker"
    }
}
