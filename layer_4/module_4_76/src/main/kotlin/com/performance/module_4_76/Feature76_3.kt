...
class Feature76Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_feature_76, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val repository0 = Feature66Repository()
        ...
        val repository6 = Feature68Repository()
        lifecycleScope.launch {
            repository6.getData()
        }
