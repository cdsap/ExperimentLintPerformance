...
class Feature33Service : Service(), LifecycleOwner {
    private val lifecycleRegistry = LifecycleRegistry(this)

    
        private val worker0 = Feature9Worker()
        private val worker1 = Feature8Worker()
        private val worker2 = Feature10Worker()
...
class Feature33Worker {
    fun doWork(): String {
        return "Work from Feature 33 Worker"
    }
}
